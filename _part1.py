...
def create_daily_hourly_chart(hourly_data, date_str, filter_mode='all'):
    ...
    # Net inflow line - only show if both are visible, or show the single type's net
    ...
    # Build subtitle based on filter
    if filter_mode == 'all':
...
def create_origin_pie_chart(monthly_data):
    ...
    # Flight origin to region mapping
    airport_regions = {
    ...
    # Cruise line to region composition (from CSV data)
    cruise_composition = {
